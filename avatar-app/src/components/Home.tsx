...
// Import BOTH logo versions again
import logoForLightMode from "../assets/logo-for-white.png"; // Dark logo for light background
import logoForDarkMode from "../assets/logoforblack.png"; // Light logo for dark background (MAKE SURE THIS FILE EXISTS and name is correct)

// Define the props interface
interface HomeProps {
  setActiveTab: (tab: string) => void;
  currentTheme: "light" | "dark"; // Accept theme prop
}

// Use the interface and destructure props
export const Home: React.FC<HomeProps> = ({ setActiveTab, currentTheme }) => {
  // Debug log to check the theme prop value
  console.log("Home Component Theme:", currentTheme);
  ...
  return (
    <div className="container">
      <div className="text-center mt-4">
        {/* --- LOGO IMAGE --- */}
        <img
          // Conditionally set the src based on the currentTheme prop
