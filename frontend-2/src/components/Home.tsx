    ...
    <div className="container">
      <div className="text-center mt-4">
        ...
        <img
          ...
          height="110" // Adjust height as desired (can be larger than navbar)
          className="mb-4 d-block mx-auto" // Margin bottom + centering
        ...
        <p className="lead text-white-50 mb-5">
          {" "}
          {/* Using text-white-50 for softer lead text */}
          Create realistic digital avatars that look and sound like you
        </p>
        {/* Feature Cards */}
        <div className="row justify-content-center g-4">
          {" "}
          {/* Added gap utility g-4 */}
          {/* Card 1 */}
          <div className="col-md-4 col-lg-3">
            {" "}
            {/* Adjusted column size */}
            {/* Added hover effect to cards */}
            <div className="card h-100 text-dark text-center shadow-sm btn-animated">
        ...
        <div className="mt-5 mb-5">
          <button
            className="btn btn-primary btn-lg px-5 py-3 btn-animated" // Add class, increased padding
