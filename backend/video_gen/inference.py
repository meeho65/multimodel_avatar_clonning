...
if __name__ == '__main__':
    ...
    parser.add_argument("--driven_audio", help="path to driven audio")
    ...
    parser.add_argument('--net_recon', type=str, default='resnet18', choices=['resnet18', 'resnet34', 'resnet50'], help='useless')
